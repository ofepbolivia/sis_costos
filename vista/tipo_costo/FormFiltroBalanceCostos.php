...
<script>
Phx.vista.FormFiltroBalanceCostos=Ext.extend(Phx.frmInterfaz,{
    ...
    {   
        ...
        Phx.vista.FormFiltroBalanceCostos.superclass.constructor.call(this,config);
        this.init(); 
        this.iniciarEventos();   
    ...
    Atributos:[
	     ...
	     
		 {
	       	...
	       	},
	      {
	       		config:{
	       			name: 'tipo_reporte',
	       			qtip : 'Tipo de clasificación de cosot por periodo o por categoria programática?',
    ...
    onSubmit: function(o) {
    	...
    	if (me.form.getForm().isValid()) {
             ...
             Ext.Ajax.request({
						url : '../../sis_costos/control/TipoCosto/reporteBalanceCostos',
