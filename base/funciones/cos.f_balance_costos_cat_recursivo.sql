...
CREATE OR REPLACE FUNCTION cos.f_balance_costos_cat_recursivo (
  p_desde date,
  p_hasta date,
...
BEGIN
    ...
    v_nombre_funcion = 'cos.f_balance_costos_cat_recursivo';
    ...
    FOR  v_registros in (
                         ...
                         IF  v_registros.sw_trans = 'movimiento' THEN
                              ...
                              FOR v_reg_ctc in (
                                   ...
                                   v_cont_nro_nodo_temp =  cos.f_balance_costos_cuenta_cat(
                                      											p_desde, 
                                      											p_hasta, 
                                                                                pa_id_deptos, 
                          ...
                          ELSE 
                             ...
                             v_cont_nro_nodo_aux  =  cos.f_balance_costos_cat_recursivo(
                                                    p_desde, 
                                                    p_hasta, 
                                                    pa_id_deptos,
