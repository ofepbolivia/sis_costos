...
CREATE OR REPLACE FUNCTION cos.f_balance_costos_cuenta (
  p_desde date,
  p_hasta date,
...
BEGIN
    ...
    v_nombre_funcion = 'cos.f_balance_costos_cuenta';    
    ...
    v_cont_nro_nodo_temp  = cos.f_balance_costos_auxiliar(p_desde, 
                                           p_hasta, 
                                           pa_id_deptos, 
                                           v_cont_nro_nodo + 1,
                                           v_codigo_orden_aux, 
